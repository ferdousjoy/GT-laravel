...
<a type="button" class="btn btn-info" data-toggle="modal" data-target="#exampleModalLong">
   <h6 class="head_title">Update Biometric </h6>
</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Biometric  Update</h5>
      ...
      <div class="modal-body">
        <div class="row input_row">
          <div class="">
            <form class="" action="{{url('/U2')}}" method="post" enctype="multipart/form-data">
              @csrf
